...
<ReadMore>Para una lista completa de variables de entorno, consulta la [documentación de Variables de Entorno](/es/start-here/environment-variables/).</ReadMore>
