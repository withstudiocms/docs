...
- **`/studiocms_api/auth/[provider]`**: El endpoint de proveedor de autenticación de la API de StudioCMS, donde `[provider]` es el nombre del proveedor (e.g. `github`, `discord`, `google`, `auth0`).
- **`/studiocms_api/auth/[provider]/callback`**: El endpoint de callback de proveedor de autenticación de la API de StudioCMS, donde `[provider]` es el nombre del proveedor (e.g. `github`, `discord`, `google`, `auth0`).
