...
`@withstudiocms/template-lang` es un lenguaje de plantillas simple MIT Licenciado TypeScript ESM para plantillas de correo electrónico HTML, similar a Handlebars pero enfocado en simplicidad y integración de datos de base de datos.
