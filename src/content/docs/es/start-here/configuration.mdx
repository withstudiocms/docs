...
<ReadMore>
Esta página te muestra cómo y dónde definir la configuración de StudioCMS. Para más información sobre las opciones de configuración de StudioCMS, consulta las [páginas de referencia](/config-reference/options-schema/).
</ReadMore>
