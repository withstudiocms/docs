...
3. Establece las variables de entorno requeridas para el Gestor de Almacenamiento S3 en tu archivo `.env`:
   ...
   <ReadMore>Para más información sobre las variables de entorno con el Gestor de Almacenamiento S3, consulta [Almacenamiento S3: Variables de entorno](/es/package-catalog/storage-managers/s3-storage/#environment-variable-examples)</ReadMore>
