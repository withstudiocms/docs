...
Visita [nuestro panel de i18n](https://crowdin.com/project/studiocms) para ayudar a traducir StudioCMS a tu idioma. Si tu idioma no está en la lista, puedes agregarlo dentro del panel.

**En este momento solo soportamos contribuciones de traducción via Crowdin.** Y las nuevas traducciones deberían usar los idiomas de **idioma internacional** si están disponibles. Cualquier contribución a archivos de traducción via GitHub será sobrescrito en la próxima sincronización de Crowdin.

Una vez que las traducciones se hayan agregado y aprobadas, se añadirán automáticamente a la [configuración i18n de StudioCMS](https://github.com/withstudiocms/studiocms/tree/main/packages/studiocms/src/virtuals/i18n) y estarán disponibles en la próxima versión.
