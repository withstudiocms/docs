...
- Actualiza las instrucciones del primer paso de configuración paso 3. Anteriormente mostraban instrucciones obsoletas relacionadas con `@astrojs/db`, que ha sido eliminada. Las nuevas instrucciones proporcionan guía actualizada sobre cómo configurar la conexión de base de datos para StudioCMS.
