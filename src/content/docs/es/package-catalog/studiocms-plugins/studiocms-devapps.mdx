...
![Aplicación de barra de herramientas de Astro](./assets/devapps-1-toolbar-app-closed.png)

- Aplicación de barra de herramientas (Expandida)

![Aplicación de barra de herramientas de Astro (Expandida)](./assets/devapps-1-toolbar-app-expanded.png)
...
![Aplicación de barra de herramientas de Astro](./assets/devapps-2-importer.png)
