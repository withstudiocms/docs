...
[db-url-token]: /de/start-here/environment-variables/#database-url-and-token-for-astrojsdb
[encryption-key]: /de/start-here/environment-variables/#encryption-key-for-studiocmsauth
[oauth-environment-variables]: /de/start-here/environment-variables/#oauth-authentication-environment-variables
