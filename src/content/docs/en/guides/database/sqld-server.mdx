...
```sh
CMS_LIBSQL_URL=http://localhost:8080 # This should point to your docker server/local system
CMS_LIBSQL_AUTH_TOKEN= # paste your Standard JWT auth token here
```
...
- Using the JWT token as an environment variable (the same CMS_LIBSQL_AUTH_TOKEN value you used in your .env file)
