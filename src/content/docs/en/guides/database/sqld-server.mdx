...
<ReadMore>Learn more about `sqld` using their [Documentation](https://github.com/tursodatabase/libsql/blob/main/docs/USER_GUIDE.md)</ReadMore>

## Prerequisites

- [Docker and Docker Compose](https://docs.docker.com/get-started/get-docker/) (either running on a server or locally)
- [OpenSSL](https://docs.openssl.org/3.2/man7/ossl-guide-introduction/#getting-and-installing-openssl) installed
...
3. Follow the first time setup for your new database.
   ...
   - See [Getting Started](/en/start-here/getting-started/#first-time-setup-or-during-updates-if-the-tables-schema-is-updated)
