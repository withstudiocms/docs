...
- Integrated optional web-vitals/analytics tracking into the dashboard for better performance insights.
  - This can be enabled via the [`features.webVitals`](/en/config-reference/features/#webvitals) config option.
...
- Added new CLI command [`studiocms debug`](/en/how-it-works/cli/#debug) to quickly access helpful debug information about your StudioCMS project.
...
8. **Running Schema Migrations:**
   ...
   <TabItem label="Using the Migration Tool">
    ...
    Alternatively, you can use the migration tool you installed in previous step. To do this, continue to the next step, and use the Web UI to run the migrations.
...
1. Once the migration is complete, **start your StudioCMS project** as usual:
