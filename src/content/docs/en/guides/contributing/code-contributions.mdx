...
description: Learn how to contribute code to StudioCMS
sidebar:
  order: 2
---
...
Oh and you will see your face in the [list of contributors][contributors]! 🎉

{/* Links */}
[contributors]: /en/guides/contributing/getting-started/#our-contributors