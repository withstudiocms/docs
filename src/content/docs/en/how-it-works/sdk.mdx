...
<ReadMore>
The StudioCMS SDK is powered by the [`@withstudiocms/sdk` package](/en/utils/kysely-and-sdk/#the-sdk-package), which provides additional functionality and utilities for working with StudioCMS. For more information, check out the [Kysely and SDK documentation](/en/utils/kysely-and-sdk/).
</ReadMore>