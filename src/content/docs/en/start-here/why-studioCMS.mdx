...
i18nReady: true
title: Why StudioCMS?
description: StudioCMS is an alternative to traditional CMS platforms. It is a headless CMS that relies on Astro to deliver a seamless content management experience.
sidebar:
  order: 4
  badge:
    text: Updated
...
- **Custom Database Solution:** Powered by [Kysely](https://kysely.dev/), StudioCMS works with multiple database dialects including libSQL, MySQL, and PostgreSQL, with the flexibility to add more as needed.
