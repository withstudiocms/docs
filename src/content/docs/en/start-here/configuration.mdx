...
<ReadMore>
This page shows you how and where to define the StudioCMS Config. For more information on the StudioCMS config options, see the [Reference pages](/config-reference/options-schema/).
</ReadMore>
