...
<Aside>
The `studiocms.config.*` file just like the Astro Config file, supports the following file types: `.cjs`, `.js`, `mjs`, `.cts`, `.ts`, `.mts`. The following example will show `.mjs` file extension being used.
</Aside>
