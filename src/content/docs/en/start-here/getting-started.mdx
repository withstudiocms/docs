...
This guide was recently revised for StudioCMS `0.1.0-beta.31`. If you've previously read this guide, please the review the changes carefully to ensure you are up to date with the latest setup instructions.
