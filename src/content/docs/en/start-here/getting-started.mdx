...
<Tabs syncKey='db-setup-method'>     
  <TabItem label="libSQL (default)" icon="database">
    <PackageManagers type='add' pkg="@libsql/client" />
  </TabItem>
...
#### Optional: Configure oAuth authentication <Badge text='Revised 0.5.0' variant='caution' />
...
|----------|---------------|
| [GitHub](/en/package-catalog/studiocms-plugins/studiocms-oauth/#github)   | `/studiocms_api/auth/github/callback` |
| [Discord](/en/package-catalog/studiocms-plugins/studiocms-oauth/#discord) | `/studiocms_api/auth/discord/callback` |
| [Google](/en/package-catalog/studiocms-plugins/studiocms-oauth/#google)   | `/studiocms_api/auth/google/callback` |
| [Auth0](/en/package-catalog/studiocms-plugins/studiocms-oauth/#auth0)     | `/studiocms_api/auth/auth0/callback` |
...
[turso-sponsor-link]: https://turso.tech/