...
|----------|---------------|
| [GitHub](/en/package-catalog/studiocms-plugins/studiocms-oauth/)   | `/studiocms_api/auth/github/callback` |
| [Discord](/en/package-catalog/studiocms-plugins/studiocms-oauth/) | `/studiocms_api/auth/discord/callback` |
| [Google](/en/package-catalog/studiocms-plugins/studiocms-oauth/)   | `/studiocms_api/auth/google/callback` |
| [Auth0](/en/package-catalog/studiocms-plugins/studiocms-oauth/)     | `/studiocms_api/auth/auth0/callback` |
