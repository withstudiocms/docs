...
<ReadMore>Pour connaître les modules d'extension de gestion du stockage disponibles, consultez le [catalogue des paquets](/fr/package-catalog#storage-managers).</ReadMore>
