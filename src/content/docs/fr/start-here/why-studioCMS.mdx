...
- **Solution de base de données personnalisée :** Propulsé par [Kysely](https://kysely.dev/), StudioCMS fonctionne avec plusieurs dialectes de base de données, notamment libSQL, MySQL et PostgreSQL, avec la possibilité d'en ajouter d'autres au besoin.
