...
<ReadMore>
Pour plus d'informations sur l'API de stockage dans StudioCMS, consultez la [documentation de spécification de l'API des intégrations](/fr/api-docs/integration).
</ReadMore>
