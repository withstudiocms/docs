...
description: "Options pour le rendu du contenu sur un frontend personnalisé"
---
...
<Aside>
Veuillez noter que l’utilisation de notre système de rendu nécessite que vous disposiez d’un module d’extension pour StudioCMS fournissant un moteur de rendu, tel que `@studiocms/md`, `@studiocms/html` ou un [module d’extension personnalisé qui fournit un moteur de rendu](/fr/plugins/renderers/) pour votre type de contenu. Le moteur de rendu gérera le rendu du contenu en fonction du type de page défini dans votre configuration de StudioCMS.
</Aside>
...
<ReadMore>
Vous souhaitez créer un module d'extension de rendu personnalisé pour StudioCMS ? Consultez notre guide sur [la création de modules d'extension de rendu personnalisés](/fr/plugins/renderers/) pour apprendre à étendre StudioCMS avec votre propre logique de rendu.
</ReadMore>
