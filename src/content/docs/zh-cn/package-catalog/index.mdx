...
Any package labeled as <Badge text="Publicly Usable" variant="caution"/> is able to be installed and used in projects that do not rely on studiocms. They can work on their own.
